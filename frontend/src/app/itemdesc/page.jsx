        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm text-gray-400">
            ...
            <p><strong>Status:</strong>{' '}
              <span className={item.isAvailable ? 'text-green-400' : 'text-red-500'}>
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            {item.tags.map(tag => (
              <span key={tag} className="text-xs bg-red-700 px-2 py-1 rounded-full text-white">
                #{tag}
              </span>
            ))}
          </div>
          ...
          <div className="mt-6 text-sm text-gray-400 border-t border-gray-700 pt-4">
            ...
            <p><strong>Contact:</strong> {item.uploader.email}</p>
          </div>
