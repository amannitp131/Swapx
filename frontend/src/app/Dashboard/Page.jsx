...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:5000/api/auth/me", {
      ...
      .then((res) => res.json())
      .then((data) => {
        // Correctly extract user from response
        setUser(data.user);
        setLoading(false);
      })
  ...
  const handleAddItem = async () => {
    ...
    try {
      ...
      // Optionally update listedItems here if you fetch them from API
      closeModal();
      setNewItem({
        title: "",
        condition: "",
  ...
  // Dummy items and swaps (replace with API data if available)
  const listedItems = [];
  const ongoingSwaps = [];
  ...
  return (
    <main className="min-h-screen bg-black text-white py-10 px-4">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <section className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 rounded-xl p-8 shadow-lg border border-red-600 flex flex-col sm:flex-row items-center gap-8 mb-8">
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 gap-4 text-lg">
              ...
              <div>
                <span className="font-semibold text-gray-300">Coins:</span>
                <span
              ...
              <div>
                <button
                  ...
                  className="inline-block bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg shadow transition-all cursor-pointer"
                >
                  Edit Profile
                </button>
              </div>
            ...
            <div className="mt-6 flex gap-4">
              ...
              <button
                ...
                className="inline-block bg-red-700 hover:bg-red-800 text-white px-4 py-2 rounded-lg shadow transition-all cursor-pointer"
              >
                Logout
              </button>
            </div>
        ...
        {/* Items and swaps sections remain unchanged */}
        <section>
